...
\section{\faBriefcase}{Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \vspace{1pt}\small{
        \newline{Integrate these tools in the pipeline: SonarQube (Code quality), Checkmarx (SAST), SonaType (SCA), Prisma (CSS), Snyk...}
        \newline{Patch CVE configurations in Linux.}
      }\vspace{-1pt}
    ...
    \resumeItemListStart
      ...
      \vspace{2pt}\small{
        \newline{Boost up performance by using Redis.}
        \newline{Sync data between databases using Kafka.}
      }\vspace{-1pt}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \vspace{1pt}\small{
        \newline{Program ComVeh for Huyndai, Suzuki.}
        \newline{Program ComDia for Nissan.}
      }\vspace{-1pt}
