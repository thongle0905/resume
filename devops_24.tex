...
\section{\faBriefcase}{Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItem {Structurally modulized existing AWS resources which were manually provisioned by using Terraform.}
      \resumeItem {Onboarded services to ECS, EKS, \textbf{customize K8s and Jenkins resources} based on exposed configurations from Platform.}
